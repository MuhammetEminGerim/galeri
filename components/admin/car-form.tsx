...
import { Upload, X, Loader2, Image as ImageIcon, Info, Settings, FileText, Star, PlusCircle, Save } from 'lucide-react';
  ...
  return (
    <Form {...form}>
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6 pb-24 md:pb-0">
        ...
        <Accordion type="single" collapsible defaultValue="images" className="w-full space-y-4">

          {/* Images Section */}
          <AccordionItem value="images" className="border-none">
            <Card className="!border !border-gray-500 dark:!border-gray-600 !shadow-[0_2px_8px_rgba(0,0,0,0.15)] dark:!shadow-[0_2px_8px_rgba(0,0,0,0.4)] overflow-hidden">
              <AccordionTrigger className="px-6 py-4 hover:no-underline bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-blue-950/30 dark:to-indigo-950/30">
                <div className="flex items-center gap-3">
                  ...
                  <div className="text-left">
                    ...
                    <CardDescription className="mt-1">Aracın fotoğraflarını yükleyin</CardDescription>
                  </div>
                </div>
              </AccordionTrigger>
          ...
          <AccordionItem value="basic-info" className="border-none">
            <Card className="!border !border-gray-500 dark:!border-gray-600 !shadow-[0_2px_8px_rgba(0,0,0,0.15)] dark:!shadow-[0_2px_8px_rgba(0,0,0,0.4)] overflow-hidden">
              <AccordionTrigger className="px-6 py-4 hover:no-underline bg-gradient-to-r from-violet-50 to-purple-50 dark:from-violet-950/30 dark:to-purple-950/30">
                <div className="flex items-center gap-3">
                  ...
                  <div className="text-left">
                    ...
                    <CardDescription className="mt-1">Marka, model ve fiyat</CardDescription>
                  </div>
                </div>
              </AccordionTrigger>
              <AccordionContent className="px-6 pb-6 pt-2">
          ...
          <AccordionItem value="specs" className="border-none">
            <Card className="!border !border-gray-500 dark:!border-gray-600 !shadow-[0_2px_8px_rgba(0,0,0,0.15)] dark:!shadow-[0_2px_8px_rgba(0,0,0,0.4)] overflow-hidden">
              <AccordionTrigger className="px-6 py-4 hover:no-underline bg-gradient-to-r from-amber-50 to-orange-50 dark:from-amber-950/30 dark:to-orange-950/30">
                <div className="flex items-center gap-3">
                  ...
                  <div className="text-left">
                    ...
                    <CardDescription className="mt-1">Yakıt, vites ve durum</CardDescription>
                  </div>
                </div>
              </AccordionTrigger>
              <AccordionContent className="px-6 pb-6 pt-2">
          ...
          <AccordionItem value="description" className="border-none">
            <Card className="!border !border-gray-500 dark:!border-gray-600 !shadow-[0_2px_8px_rgba(0,0,0,0.15)] dark:!shadow-[0_2px_8px_rgba(0,0,0,0.4)] overflow-hidden">
              <AccordionTrigger className="px-6 py-4 hover:no-underline bg-gradient-to-r from-cyan-50 to-blue-50 dark:from-cyan-950/30 dark:to-blue-950/30">
                <div className="flex items-center gap-3">
                  ...
                  <div className="text-left">
                    ...
                    <CardDescription className="mt-1">Detaylı bilgi</CardDescription>
                  </div>
                </div>
              </AccordionTrigger>
              <AccordionContent className="px-6 pb-6 pt-2">
          ...
          <AccordionItem value="featured" className="border-none">
            <Card className="!border-2 !border-amber-400 dark:!border-amber-600 !shadow-[0_4px_12px_rgba(251,191,36,0.25)] dark:!shadow-[0_4px_12px_rgba(251,191,36,0.4)] overflow-hidden">
                    ...
                    <FormItem className="flex flex-row items-start space-x-4 space-y-0">
                      ...
                      <div className="flex-1 space-y-2">
                        ...
                        <FormDescription className="text-sm">
                          Bu araç ana sayfada öne çıkan araçlar bölümünde gösterilecektir.
                        </FormDescription>
                      </div>
                    </FormItem>
                  )}
        ...
        <div className="fixed bottom-0 left-0 right-0 p-4 bg-white/80 dark:bg-zinc-950/80 backdrop-blur-lg border-t border-gray-200 dark:border-gray-800 flex gap-3 z-50 md:relative md:bg-transparent md:border-none md:p-0 md:pt-4">
          <Button
            type="submit"
            size="lg"
